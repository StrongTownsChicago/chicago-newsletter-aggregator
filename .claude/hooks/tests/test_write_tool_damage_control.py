...
class TestWriteToolDamageControl(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.validator_path = Path(__file__).parent.parent / "write-tool-damage-control.py"
    ...
    def assert_blocked(self, file_path: str, reason_substring: str = ""):
        ...
        self.assertEqual(exit_code, 2, f"Expected write to be blocked: {file_path}\nstderr: {stderr}")
        if reason_substring:
    ...
    def assert_allowed(self, file_path: str):
        ...
        exit_code, stdout, stderr = self.validate_write(file_path)
        self.assertEqual(exit_code, 0, f"Expected write to be allowed: {file_path}\nstderr: {stderr}")
    ...
    def test_allows_writing_readme(self):
        """Allow writing README.md."""
        self.assert_allowed("README.md")

    def test_allows_writing_license(self):
