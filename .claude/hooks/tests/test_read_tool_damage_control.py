...
class TestReadToolDamageControl(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.validator_path = Path(__file__).parent.parent / "read-tool-damage-control.py"
    ...
    def assert_blocked(self, file_path: str, reason_substring: str = ""):
        ...
        self.assertEqual(exit_code, 2, f"Expected read to be blocked: {file_path}\nstderr: {stderr}")
        if reason_substring:
    ...
    def assert_allowed(self, file_path: str):
        ...
        exit_code, stdout, stderr = self.validate_read(file_path)
        self.assertEqual(exit_code, 0, f"Expected read to be allowed: {file_path}\nstderr: {stderr}")
    ...
    def test_blocks_env_in_subdir(self):
    ...
    def test_blocks_terraform_state(self):
    ...
    def test_allows_reading_package_lock(self):
        """Allow reading package-lock.json."""
        self.assert_allowed("package-lock.json")

    def test_allows_reading_system_files(self):
    ...
    def test_allows_reading_readme(self):
        """Allow reading README.md."""
        self.assert_allowed("README.md")

    def test_allows_reading_git_config(self):
